// List of UN member states and their primary timezones
export const unCountries: Record<string, string[]> = {
  ...
  'Russia': ['Europe/Moscow', 'Asia/Novosibirsk', 'Asia/Vladivostok'],
